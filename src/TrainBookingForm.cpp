...
{
    m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Departure Station:"));
    m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Arrival Station:"));
    m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Departure Date:"));
    m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Number of Passengers:"));
