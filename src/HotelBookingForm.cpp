...
{ 
	m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Hotel Name:"));
	m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Check-in Date:"));
	m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Check-out Date:"));
	m_inputFields.push_back(std::make_unique<InputChar>(m_yOffset += 50, "Number of Guests:"));
