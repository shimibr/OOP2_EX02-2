...
{ 
	...
	m_inputFields.push_back(std::make_unique<FieldToInputSelect>(m_yOffset += 50, "Room Type:", std::vector<std::string>{ "Single Room","Double Room","Family Room","Presidential Suite" },0));
    setbuttons();
}
